...
public class AlipayCore {
     ...
     * @return 签名结果字符串
     */
    public static String buildMysign(Map<String, String> sArray,String prikeyMD5) {
    ...
    public static Map<String, String> paraFilter(Map<String, String> sArray) {
        ...
        for (String key : sArray.keySet()) {
            ...
            if (value == null || value.equals("") || key.equalsIgnoreCase("sign")
                || key.equalsIgnoreCase("sign_type") || key.equalsIgnoreCase("appKey")) {
                continue;
            }
     ...
     * @return 签名结果字符串
     */
    public static String buildMysign_RSA(Map<String, String> sArray,String privateKey,String encode) {
        String prestr = createLinkString(sArray); //把数组所有元素，按照“参数=参数值”的模式用“&”字符拼接成字符串
        System.out.println("ALIPAYFundChannelKey.RSA_key=="+privateKey);

        //解码异步回调uri
//        String realUri = decodeUri(prestr,encode);

        String mysign = AlipayRsaEncrypt.sign(prestr, privateKey);
