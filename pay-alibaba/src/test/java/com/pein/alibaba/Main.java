...
import com.pein.alibaba.config.Configs;
import com.pein.alibaba.model.ExtendParams;
import com.pein.alibaba.model.GoodsDetail;
import com.pein.alibaba.model.builder.AlipayTradePayRequestBuilder;
import com.pein.alibaba.model.builder.AlipayTradePrecreateRequestBuilder;
import com.pein.alibaba.model.builder.AlipayTradeQueryRequestBuilder;
import com.pein.alibaba.model.builder.AlipayTradeRefundRequestBuilder;
import com.pein.alibaba.model.result.AlipayF2FPayResult;
import com.pein.alibaba.model.result.AlipayF2FPrecreateResult;
import com.pein.alibaba.model.result.AlipayF2FQueryResult;
import com.pein.alibaba.model.result.AlipayF2FRefundResult;
import com.pein.alibaba.service.AlipayMonitorService;
import com.pein.alibaba.service.AlipayTradeService;
import com.pein.alibaba.service.impl.AlipayMonitorServiceImpl;
import com.pein.alibaba.service.impl.AlipayTradeServiceImpl;
import com.pein.alibaba.service.impl.AlipayTradeWithHBServiceImpl;
import com.pein.alibaba.utils.Utils;
...
//        String discountableAmount = "1.00"; //
    ...
    public void test_trade_precreate() {
        ...
        // 卖家支付宝账号ID，用于支持一个签约账号下支持打款到不同的收款账号，(打款到sellerId对应的支付宝账号)
        // 如果该字段为空，则默认为与支付宝签约的商户的PID，也就是appid对应的PID
        String sellerId = "2088021524218801";
